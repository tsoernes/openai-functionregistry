...
def generate_pydantic_model(func):
    """
    Generate a Pydantic BaseModel for the given function's parameter definition and docstring.

    This BaseModel can in turn be used to generate an LLM function definition.
    """
...
def test():
    ...
    print(openai.pydantic_function_tool(SomeFunctionModel))
    print(convert_to_openai_function(some_function))
